...
**DUE TO THE CHANGES INSIDE THE RELEASE 0.2.6(see the [release note](https://github.com/kodLite/cppStartingKit/blob/master/messages/0.2.6.txt)) THIS DOCUMENTATION IS OUT OF DATE BUT STILL CONTAINS RELEVANT INFORMATIONS. THIS WILL BE FIXED AS SOON AS POSSIBLE.**
